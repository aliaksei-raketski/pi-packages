...
import { BASH_PROMPT_GUIDELINES, BASH_PROMPT_SNIPPET } from '../prompt.js';
import { renderBashCall, renderBashResult } from '../render.js';
import { BashInputSchema, type BashInput } from '../schemas.js';
...
export function registerBashTool(pi: ExtensionAPI, runtime: TmuxBashRuntime): void {
  pi.registerTool({
    ...
    promptGuidelines: runtime.config.systemPrompt ? BASH_PROMPT_GUIDELINES : [],
