...
function mergeColorEntries(base: ColorConfigValue, override: ColorConfigValue): ColorConfigValue {
...
export function resolveColorValue(
  ...
  if (configured !== undefined) {
    ...
    if (state !== undefined && typeof (configured as Record<string, unknown>)[state] === 'string') {
